...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin/halls')->name('admin.halls.')->group(function () {
        ...
        Route::post('/{hall}/activate', [AdminController::class, 'activateHall'])->name('activate');
        Route::post('/{hall}/deactivate', [AdminController::class, 'deactivateHall'])->name('deactivate');
    });
    ...
    Route::prefix('admin/movies')->name('admin.movies.')->group(function () {
        ...
        Route::get('/create', [MovieController::class, 'create'])->name('create'); // форма для создания фильма
        Route::post('/store', [MovieController::class, 'store'])->name('store'); // сохранение фильма
        Route::get('/{movie}/edit', [MovieController::class, 'edit'])->name('edit'); // форма для редактирования фильма
